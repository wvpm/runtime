...
public abstract class ServiceProviderContainerTests : DependencyInjectionSpecificationTests {
	...
	private class CustomService1 : ICustomService { }

	private class CustomService2 : ICustomService { }

	private class CustomService3 : ICustomService { }

	private class CustomService4 : ICustomService { }

	private class CustomService5 : ICustomService { }

	private class CustomService6 : ICustomService { }

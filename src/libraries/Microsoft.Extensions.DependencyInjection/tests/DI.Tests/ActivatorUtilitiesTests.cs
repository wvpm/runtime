...
public class ActivatorUtilitiesTests {
	...
	private static void Collectible_LoadAndCreate(bool useCollectibleAssembly, out WeakReference asmWeakRef, out WeakReference typeWeakRef) {
		Assembly asm;
		object obj;
	...
	private static bool Collectible_IsAssemblyLoaded() {

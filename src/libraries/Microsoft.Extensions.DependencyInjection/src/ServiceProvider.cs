...
public sealed class ServiceProvider : IServiceProvider, IKeyedServiceProvider, IDisposable, IAsyncDisposable {
	...
	internal static bool DisableDynamicEngine { get; } =
		AppContext.TryGetSwitch("Microsoft.Extensions.DependencyInjection.DisableDynamicEngine", out bool disableDynamicEngine) && disableDynamicEngine;
	...
	internal sealed class ServiceProviderDebugView {
		...
		public List<ServiceDescriptor> ServiceDescriptors => new(_serviceProvider.Root.RootProvider.CallSiteFactory.Descriptors);
